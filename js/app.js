(() => {
        ...
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            R = function (e, t, s) {
              P(e, t.class_loading),
                S(e, f),
                s && (O(s, 1), k(t.callback_loading, e, s));
            },
            X = function (e, t, s) {
  ...
  (() => {
    ...
    const E = {
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (i = w(e), r = 0; r < i.length; r += 1) if (i[r] === n) return !0;
          return !1;
        }
        if (e === s) return n === s;
        if (e === t) return n === t;
    ...
    function q({ swiper: e, runCallbacks: t, direction: s, step: n }) {
    ...
    const j = {
      loopCreate: function () {
        ...
        for (let e = 0; e < o.length; e += 1)
          i.append(C(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        for (let e = a.length - 1; e >= 0; e -= 1)
      ...
      t({
        ...
        s("click", (t, s) => {
          const { $nextEl: i, $prevEl: r } = e.navigation,
            a = s.target;
          if (e.params.navigation.hideOnClick && !C(a).is(r) && !C(a).is(i)) {
            if (
              e.pagination &&
              e.params.pagination &&
    ...
    function ce({ swiper: e, extendParams: t, on: s, emit: n }) {
      ...
      function c() {
        ...
        if ("bullets" === t.type) {
          ...
          i.html(r), (e.pagination.bullets = i.find(de(t.bulletClass)));
        }
        "fraction" === t.type &&
          ((r = t.renderFraction
    ...
    function fe({ swiper: e, extendParams: t, on: s }) {
    ...
    window.addEventListener("load", function (e) {
      !(function () {
        if ((me(), document.querySelector(".thumbs-images"))) {
        ...
        document.querySelector(".main-slider__slider") &&
          ...
          document.querySelector(".lots__slider") &&
            new ae(".lots__slider", {
              modules: [le],
              observer: !0,
              observeParents: !0,
          ...
          document.querySelector(".quotes__slider") &&
            new ae(".quotes__slider", {
              modules: [le, fe],
              effect: "fade",
          ...
          document.querySelector(".products-slider__slider") &&
            new ae(".products-slider__slider", {
              ...
              breakpoints: {
                ...
                1370: { slidesPerView: 4, spaceBetween: 0 },
              },
              on: {},
            }),
          document.querySelector(".main-block__slider") &&
            new ae(".main-block__slider", {
              modules: [le, ce, pe],
              autoplay: { delay: 3e3, disableOnInteraction: !1 },
              observer: !0,
              observeParents: !0,
    ...
    new ve("max").init(),
      document
        .querySelector(".user-header__icon")
